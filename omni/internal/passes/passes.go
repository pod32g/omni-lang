...
func verifyInstruction(inst mir.Instruction) error {
	switch inst.Op {
	case "const", "add", "sub", "mul", "div", "mod", "strcat", "neg", "not", "bitnot", "bitand", "bitor", "bitxor", "lshift", "rshift", "cast", "index", "index.assign", "array.init", "map.init", "struct.init", "member", "member.assign", "call", "call.int", "call.void", "call.string", "call.bool", "iface.call", "assign", "func.ref", "func.assign", "func.call", "closure.create", "closure.capture", "closure.bind", "throw", "await":
